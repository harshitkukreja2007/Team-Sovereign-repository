...
import { BookOpen, Target, Map, Award, GraduationCap, Shield, Rocket, Sparkles, AlertTriangle } from 'lucide-react';
...
export default function App() {
  ...
  const tabs = [
    ...
    { id: 'builder', label: 'Build Roadmap', icon: Target },
    { id: 'roadmap', label: 'Your Roadmap', icon: Map },
    { id: 'score', label: 'Readiness Score', icon: Award },
    { id: 'capsules', label: 'Learning', icon: GraduationCap },
    { id: 'risk', label: 'Risk Guide', icon: AlertTriangle },
    { id: 'platforms', label: 'Next Steps', icon: Rocket },
    { id: 'safety', label: 'Safety', icon: Shield },
    { id: 'future', label: 'Future Scale', icon: Sparkles },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-4">
            <h1 className="text-xl font-semibold text-gray-900">Investor Readiness System</h1>
            <p className="text-sm text-gray-600">Learn. Simulate. Build Discipline.</p>
          </div>
        </div>
      </header>
